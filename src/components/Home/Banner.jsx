        ...
        <div className="bg-[#f2312d] py-8 lg:py-12 lg:px-24 lg:mt-20">
            <div className="container mx-auto flex flex-col lg:flex-row justify-center space-y-8 lg:space-y-0 lg:space-x-8">
                ...
                <div className="relative group w-full px-4 lg:px-0 lg:w-1/3">
                    <img
                        src="https://rrecrussia.com/public/upload/home-features/1801975810957227.jpg.webp" // replace with your image
                        alt="University 1"
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center">
                            <h3 className="text-xl font-bold">Learn Russian in SfedU</h3>
                            {/* Button */}
                            <motion.div
                                className="mt-6"
                ...
                <div className="relative group w-full px-4 lg:px-0 lg:w-1/3">
                    <img
                        src="https://rrecrussia.com/public/upload/home-features/1801975872722717.jpg.webp" // replace with your image
                        alt="University 2"
                        className="w-full h-auto transform group-hover:scale-105 rounded-lg transition-transform duration-300"
                    />
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center">
                            <h3 className="text-xl font-bold">Study in Russia</h3>
                            {/* Button */}
                            <motion.div
                                className="mt-6"
                                initial={{ y: 50, opacity: 0 }}
                ...
                <div className="relative group px-4 lg:px-0 w-full lg:w-1/3">
                    <img
                        src="https://rrecrussia.com/public/upload/home-features/1801975920058650.jpg.webp" // replace with your image
                        alt="University 3"
                        className="w-full h-auto transform group-hover:scale-105 rounded-lg transition-transform duration-300"
                    />
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-center">
                            <h3 className="text-xl font-bold">Study in Russia & English</h3>
                            {/* Button */}
                            <motion.div
                                className="mt-6"
                                initial={{ y: 50, opacity: 0 }}
