        ...
        <>
            ...
            <div className="px-4 lg:px-20 py-8 font-roboto">
                ...
                <div className="text-center">
                    ...
                    <div className="mt-4 space-y-6">
                        <p className="text-left text-justify text-md lg:text-lg font-roboto">If you are looking for MBBS abroad, Russia is the first name that comes to the mind of most Indian aspirants. A simple reason that leads their choice is that it is one of the favorite destinations for international students in recent times. It has many high-quality medical universities that draw international attention – Kursk State Medical University, Russia is one of them. It is one of the leading and most successful medical universities in Russia. It has been the center of attraction for both national and international students due to its top-grade MBBS program. KSMU is known for its innovative research and sublime facilities for students including exhaustive infrastructure.</p>
                        <p className="text-left text-justify text-md lg:text-lg font-roboto">It has been established in 1935 and got the status of a university in 1994. Since then, more than 44000 pharmacists, doctors, and healthcare specialists have successfully graduated from this university. It is among the first universities in Russia that commenced teaching graduate and undergraduate programs in English medium. Kursk State Medical University is considered among the top 10 universities in Russia due to many factors. The major reason for this university to be in the top 10 rankings is its high-quality standard and prestigious faculty members. University is well-equipped with state-of-the-art medical facilities that help students and professors to carry out comprehensive research and training activities.</p>
                    </div>
                ...
                {/* Heading */}
                <h2 className="text-xl font-semibold text-red-600 text-justify mt-6 mb-4">
            ...
            <div className="bg-red-700 mt-10 mb-6 font-roboto rounded-xl px-8 py-10 max-w-4xl lg:max-w-7xl mx-auto text-center font-roboto text-white">
                <h2 className="text-2xl font-semibold text-white text-center mt-6">
                    Call for more details about the university, admission, processing, fees at MBBS in KUSMU:
                </h2>
