        ...
        <>
            ...
            <div className="bg-red-700 mt-2 mb-6 rounded-xl px-8 py-16 max-w-4xl lg:max-w-7xl mx-auto text-center font-roboto text-white">
                <h2 className="text-xl lg:text-2xl mb-4 font-semibold">
                    Call for more details about the university, admission, processing fees at MBBS in uzbekistan (SSMU)
                </h2>
                <h6 className="mb-4">Contact Us: +91-7428212236, 7428203118</h6>
                <h6>Toll-free 1800-419-5827 (For Indian Students), +7-9515190376 (International Students)</h6>
